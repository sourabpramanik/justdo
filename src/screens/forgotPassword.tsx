...
import {VStack, HStack, Text, Center, FormControl, Stack, Box, Modal} from 'native-base'
...
const ForgotPassword = (props)=>{
    ...
    return(
        <AnimatedColorBox flex={1} space={2}>
            <TitleMastHead title="Forgot Password" subtitle="Not a problem, we can help you 👷"/>                     
                    ...
                    <Modal isOpen={passwordModal} size="xl" onClose={handlePasswordModal}>
                        <Modal.Content maxWidth="450">
                            ...
                            <Modal.Header  bg="blue.500">
                                <Text fontSize={20} color="white" bold >Change the Password</Text>
                            </Modal.Header>
                            <Modal.Body>
                                <FormControl>
                                    <FormControl.Label>
                                        <Text fontSize={16} color="blue.500" bold>Enter the confirmation code recieved in your email and new password.</Text>
                                    </FormControl.Label>
                                    <InputField
